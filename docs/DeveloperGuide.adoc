...
|`* * *` |user |delete a trip |remove entries that I no longer need

|`* * *` |user |find a trip by name |locate details of trips without having to go through the entire list

|`* *` |user |hide <<private-contact-detail,private contact details>> by default |minimize chance of someone else seeing them by accident

|`*` |user with many trips in the location book |sort trips by name |locate a trip easily
|=======================================================================
...
[discrete]
=== Use case: Delete trip

*MSS*

1.  User requests to list trips
2.  AddressBook shows a list of trips
3.  User requests to delete a specific trip in the list
4.  AddressBook deletes the trip
+
Use case ends.
...
.  Should be able to hold up to 1000 trips without a noticeable sluggishness in performance for typical usage.
