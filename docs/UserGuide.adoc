...
==== 3.2.4 Navigating to a feature in the trip page: `goto` 
...
Format: `add n/NAME [p/PHONE_NUMBER] [a/AGE] m/MET_IN h/HOW_YOU_MET [p/PERSONALITY] [f/FAVOURITE]`
...
Format: `edit INDEX [n/NAME] [p/PHONE_NUMBER] [a/AGE] [m/MET_IN] [h/HOW_YOU_MET] [p/PERSONALITY] [f/FAVOURITE]`
...
Format: `find FIELD [n/NAME]/ [p/PHONE_NUMBER]/ [a/AGE]/ [m/MET_IN] [h/HOW_YOU_MET]/ [p/PERSONALITY]/ [f/FAVOURITE]`
