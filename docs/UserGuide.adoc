...
Adds a trip to the location book +
Format: `add n/NAME p/PHONE_NUMBER e/EMAIL a/ADDRESS [t/TAG]...`

[TIP]
A trip can have any number of tags (including 0)
...
Shows a list of all trips in the location book. +
Format: `list`

=== Editing a trip : `edit`

Edits an existing trip in the location book. +
...
Edits the phone number and email location of the 1st trip to be `91234567` and `johndoe@example.com` respectively.
* `edit 2 n/Betsy Crower t/` +
Edits the name of the 2nd trip to be `Betsy Crower` and clears all existing tags.
...
* `find Betsy Tim John` +
Returns any trip having names `Betsy`, `Tim`, or `John`

// tag::delete[]
=== Deleting a trip : `delete`

Deletes the specified trip from the location book. +
Format: `delete INDEX`
...
* `list` +
`delete 2` +
Deletes the 2nd trip in the location book.
* `find Betsy` +
`delete 1` +
Deletes the 1st trip in the results of the `find` command.
