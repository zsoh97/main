...
public class EditCommandTest {
    ...
    private Model model = new HomeModelManager(getTypicalTripList(), new UserPrefs());
    ...
    public void execute_allFieldsSpecifiedUnfilteredList_success() {
        ...
        Model expectedModel = new HomeModelManager(new TripList(model.getTripList()), new UserPrefs());
    ...
    public void execute_someFieldsSpecifiedUnfilteredList_success() {
        ...
        Trip editedTrip = personInList.withName(VALID_DATEFROM_CNY).withLocation(VALID_LOCATION_CNY)
                .withDateRange(VALID_DATEFROM_CNY, VALID_DATETO_CNY).build();

        EditCommand.EditTripDescriptor descriptor = new EditTripDescriptorBuilder().withName(VALID_TRIPNAME_GRADTRIP)
