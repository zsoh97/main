...
public class EditCommand extends Command {
     ...
     * @param editPersonDescriptor details to edit the trip with
     */
    ...
    public CommandResult execute(Model model) throws CommandException {
        ...
        Trip editedTrip = createEditedPerson(tripToEdit, editPersonDescriptor);
     ...
     */
    private static Trip createEditedPerson(Trip tripToEdit, EditPersonDescriptor editPersonDescriptor) {
