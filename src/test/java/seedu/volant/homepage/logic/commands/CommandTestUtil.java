...
import static seedu.volant.commons.logic.parser.CliSyntax.PREFIX_ADDRESS;
import static seedu.volant.commons.logic.parser.CliSyntax.PREFIX_EMAIL;
import static seedu.volant.commons.logic.parser.CliSyntax.PREFIX_NAME;
import static seedu.volant.commons.logic.parser.CliSyntax.PREFIX_PHONE;
...
public class CommandTestUtil {
    ...
    public static void assertCommandFailure(Command command, Model actualModel, String expectedMessage) {
        ...
        TripList expectedAddressBook = new TripList(actualModel.getAddressBook());
        List<Trip> expectedFilteredList = new ArrayList<>(actualModel.getFilteredPersonList());
    ...
    public static void showPersonAtIndex(Model model, Index targetIndex) {
        ...
        Trip trip = model.getFilteredPersonList().get(targetIndex.getZeroBased());
