...
import seedu.volant.testutil.TypicalPersons;
...
public class JsonSerializableLocationBookTest {
    ...
    public void toModelType_typicalPersonsFile_success() throws Exception {
        ...
        TripList typicalPersonsAddressBook = TypicalPersons.getTypicalAddressBook();
    ...
    public void toModelType_duplicatePersons_throwsIllegalValueException() throws Exception {
        JsonSerializableTripList dataFromFile = JsonUtil.readJsonFile(DUPLICATE_PERSON_FILE,
                JsonSerializableTripList.class).get();
        assertThrows(IllegalValueException.class, JsonSerializableTripList.MESSAGE_DUPLICATE_PERSON,
